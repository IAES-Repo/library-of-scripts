...
SCP_HOST = "IP_ADDRESS"  # Remote server IP address
SCP_USER = "USER"           # SSH username for remote server
SCP_PATH = "SCP_PATH"       # Destination path on remote server
SCP_KEY = "KEY_PATH"  # Path to SSH private key
